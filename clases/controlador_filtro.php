...
// NUEVA REGLA: si es especial y PAGADO, no debe existir view_dataSUBIRF (ni SUBIR FACTURA ni MODIFICAR)
$ocultarSubirF = ($esViaticoEspecial && $STATUS_DE_PAGO === 'PAGADO');
?>
...
<?php if (
    !$ocultarSubirF && // 👈 AQUI SE OCULTA TODO view_dataSUBIRF EN ESOS CASOS
    $database->variablespermisos('', 'CALE_SUBE_PAGOVYO', 'ver') === 'si'
): ?>
