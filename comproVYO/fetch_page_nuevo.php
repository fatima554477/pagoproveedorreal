...
<div id="target2" style="display:block;" class="content2">
    ...
    <button class="btn btn-sm btn-outline-primary px-4" type="button" onclick="exportarExcelFiltrado2();">📊 Exportar a Excel</button>
</td>
    ...
    ?>
						...
						<p><strong style="background:#ffb6c1"> ROSA:</strong> FORMAS DE PAGO DIFERENTES A (04 TARJETA DE CREDITO)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong style="background:#fdfe87"> AMARILLO:</strong> COMPROBACIÓN  SIN XML </p>
				</tr>
			</table>
