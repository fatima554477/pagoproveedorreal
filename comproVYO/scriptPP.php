...
<div id="dataModal4" class="modal fade">
  <div class="modal-dialog" style="width:80% !important; max-width:100% !important;">
    <div class="modal-content">
      <div class="modal-header" style="cursor:move;"><h4 class="modal-title">Detalles</h4></div>
...
function verificarFormaDePago() {
  ...
  if (!selectFP || selectFP.value === '') return;
    ...
    success: function (response) {
      ...
      // ── UUID duplicado en 07XML o 02XML (retorna "3|id|evento") ─────────
        ...
        if (esPagoProveedores) {
          ...
          $('#1' + nombre).html('<p style="color:red;font-weight:600;">' + mensajeDup + '</p>');
        }
        $('#' + nombre).val('');
...
function guardarYIrATarget2() {
  try { sessionStorage.setItem('irATarget', '2'); } catch(e) {}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  try {
    ...
    if (targetPendiente) sessionStorage.removeItem('irATarget');
  } catch(e) {}
...
$(document).ready(function () {
  ...
  /* ---------------------------------------------------
     BORRAR DOCUMENTO ADJUNTO (view_dataSBborrar2)
  --------------------------------------------------- */
  ...
  /* ---------------------------------------------------
     BORRAR PAGO PROVEEDOR (view_dataSBborrar)
  --------------------------------------------------- */
