...
<tr>
  ...
  <td width="70%">
    <div id="drop_file_zone" ondrop="upload_file2(event,\'ADJUNTAR_FACTURA_XML\')" ondragover="return false" style="width:300px;">
      <p>Suelta aquí o busca tu archivo</p>
      <p>
        <input class="form-control form-control-sm" id="ADJUNTAR_FACTURA_XML" type="text" onkeydown="return false" onclick="file_explorer2(\'ADJUNTAR_FACTURA_XML\');" style="width:250px;" value="'.$row["ADJUNTAR_FACTURA_XML"].'" required />
      </p>
      <input type="file" name="ADJUNTAR_FACTURA_XML" id="nono"/>
      <div id="3ADJUNTAR_FACTURA_XML">'.$ADJUNTAR_FACTURA_XML.'</div>
    </div>
  </td>
</tr>
...
<tr>
  ...
  <td width="70%">
    <div id="drop_file_zone" ondrop="upload_file2(event,\'ADJUNTAR_FACTURA_PDF\')" ondragover="return false" style="width:300px;">
      <p>Suelta aquí o busca tu archivo</p>
      <p>
        <input class="form-control form-control-sm" id="ADJUNTAR_FACTURA_PDF" type="text" onkeydown="return false" onclick="file_explorer2(\'ADJUNTAR_FACTURA_PDF\');" style="width:250px;" value="'.$row["ADJUNTAR_FACTURA_PDF"].'" required />
      </p>
      <input type="file" name="ADJUNTAR_FACTURA_PDF" id="nono"/>
      <div id="3ADJUNTAR_FACTURA_PDF">'.$ADJUNTAR_FACTURA_PDF.'</div>
    </div>
  </td>
</tr>
...
<tr>
  <td width="30%" style="font-weight:bold;"><label>TIPO DE DOCUMENTO:</label></td>
  <td width="70%"><input type="text" readonly="readonly" name="si" value="'.$row["si"].'"></td>
</tr>


<input type="hidden" name="STATUS_CHECKBOX" value="'.$row["STATUS_CHECKBOX"].'">
...
<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <td width="70%">
        ...
        <div id="respuestaser3" class="d-inline-block ms-3" style="
    color: #f5f5f5;
...
<script>
	var fileobj;
function upload_file2(event, targetId) {
...
function file_explorer2(targetId) {
    const fileInput = document.querySelector(`input[name="${targetId}"]`);
    fileInput.click();
    fileInput.onchange = function() {
        document.getElementById(targetId).value = this.files[0]?.name || '';
    };
}
...
$("#clickPAGOP").click(function(){
    $.ajax({  
        ...
        success: function(data) {
            ...
            if (trimmedData == 'Ingresado' || trimmedData == 'Actualizado') {
                $("#respuestaser2").html("<span id='ACTUALIZADO'>" + trimmedData + "</span>");
                $("#respuestaser3").html("<span id='ACTUALIZADO'>" + trimmedData + "</span>");
                
                // Ocultar después de 4 segundos
                setTimeout(function() {
                    $("#respuestaser2").fadeOut(500, function() {
                        $(this).html('').show();
                    });
                    $("#respuestaser3").fadeOut(500, function() {
                        $(this).html('').show();
                    });
                }, 2000);
