...
$keys = array('NUMERO_CONSECUTIVO_PROVEE','RAZON_SOCIAL','EJECUTIVOTARJETA','NUMERO_EVENTO','RFC_PROVEEDOR','NOMBRE_EVENTO','MOTIVO_GASTO','CONCEPTO_PROVEE','MONTO_TOTAL_COTIZACION_ADEUDO','MONTO_FACTURA','MONTO_PROPINA','MONTO_DEPOSITAR','TIPO_DE_MONEDA','PFORMADE_PAGO','FECHA_A_DEPOSITAR_DESDE','FECHA_A_DEPOSITAR_HASTA','STATUS_DE_PAGO','BANCO_ORIGEN','ACTIVO_FIJO','GASTO_FIJO','PAGAR_CADA','FECHA_PPAGO','FECHA_TPROGRAPAGO','NUMERO_EVENTOFIJO','CLASI_GENERAL','SUB_GENERAL','MONTO_DE_COMISION','POLIZA_NUMERO','ADJUNTAR_FACTURA_XML_VACIO','NOMBRE_DEL_EJECUTIVO','NOMBRE_DEL_AYUDO','OBSERVACIONES_1','FECHA_DE_LLENADO','hiddenpagoproveedores','ADJUNTAR_COTIZACION','TIPO_CAMBIOP','TOTAL_ENPESOS','IMPUESTO_HOSPEDAJE','IVA','FECHA_INICIO_EVENTO','FECHA_FINAL_EVENTO','TImpuestosRetenidosIVA','TImpuestosRetenidosISR','descuentos','NOMBRE_COMERCIAL','PorfaltaDeFactura','UUID','total','metodoDePago','serie','folio','regimenE','UsoCFDI','TImpuestosTrasladados','TImpuestosRetenidos','Version','tipoDeComprobante','condicionesDePago','fechaTimbrado','nombreR','rfcR','Moneda','TipoCambio','ValorUnitarioConcepto','DescripcionConcepto','ClaveUnidad','ClaveProdServ','Cantidad','ImporteConcepto','UnidadConcepto','RFC_RECEPTOR','CantidadConcepto','TUA','TuaTotalCargos','Descuento','subTotal','propina','query');
$search = array();
...
$money = array('MONTO_TOTAL_COTIZACION_ADEUDO','MONTO_FACTURA','IVA','IEPS','MONTO_PROPINA','IMPUESTO_HOSPEDAJE','descuentos','MONTO_DEPOSITAR','MONTO_DEPOSITADO','TOTAL_ENPESOS','subTotal','total');
