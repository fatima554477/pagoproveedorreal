...
<td width="70%"><input type="text" readonly=»readonly»  style="background:#d7bde2"  name="TImpuestosRetenidosIVA"  id="montoRetenidoIVA" value="'.$row["TImpuestosRetenidosIVA"].'"></td>
</tr> 

<tr>
<td width="30%" style="background:#dfd9f3"><label>IMPUESTOS RETENIDOS  ISR:</label></td>
<td width="70%"><input type="text" readonly=»readonly»  style="background:#d7bde2"  name="TImpuestosRetenidosISR" id="montoRetenidoISR"  value="'.$row["TImpuestosRetenidosISR"].'"></td>
</tr> 
...
<td width="70%"><input type="text" readonly=»readonly»  style="background:#d7bde2"  name="descuentos" id="montoDescuentos"  value="'.$row["descuentos"].'"></td>
</tr> 
...
<input type="hidden" readonly=»readonly»  style="background:#d7bde2"name="ACTIVO_FIJO"  value="'.$row["ACTIVO_FIJO"].'">





<input type="hidden" readonly=»readonly»  style="background:#d7bde2"   name="GASTO_FIJO"  value="'.$row["GASTO_FIJO"].'">





<input type="hidden" readonly=»readonly»  style="background:#d7bde2"   name="PAGAR_CADA"  value="'.$row["PAGAR_CADA"].'">


<input type="hidden" readonly=»readonly»  style="background:#d7bde2"  name="FECHA_PPAGO"  value="'.$row["FECHA_PPAGO"].'">

              

<input type="hidden" readonly=»readonly»  style="background:#d7bde2"   name="FECHA_TPROGRAPAGO"  value="'.$row["FECHA_TPROGRAPAGO"].'">



<input type="hidden" readonly=»readonly»  style="background:#d7bde2"  name="NUMERO_EVENTOFIJO"  value="'.$row["NUMERO_EVENTOFIJO"].'">
<input type="hidden" readonly=»readonly»  style="background:#d7bde2"   name="CLASI_GENERAL"  value="'.$row["CLASI_GENERAL"].'">

<input type="hidden" readonly=»readonly»  style="background:#d7bde2"  name="SUB_GENERAL"  value="'.$row["SUB_GENERAL"].'">
...
<input type="hidden" readonly=»readonly»  style="background:#d7bde2" name="BANCO_ORIGEN" value="'.$row["BANCO_ORIGEN"].'">





<input type="hidden" readonly=»readonly»  style="background:#d7bde2" name="PLACAS_VEHICULO" value="'.$row["PLACAS_VEHICULO"].'">
...
<input type="hidden" readonly=»readonly»  style="background:#d7bde2" name="MONTO_DE_COMISION" value="'.$row["MONTO_DE_COMISION"].'">
